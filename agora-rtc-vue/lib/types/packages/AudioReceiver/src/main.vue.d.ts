...
declare const AgoraAudioReceiver_base: import("vue-class-component/lib/declarations").VueClass<unknown>;
export default class AgoraAudioReceiver extends AgoraAudioReceiver_base {
