import { ILocalAudioTrack, ILocalVideoTrack, ScreenVideoTrackInitConfig, ICameraVideoTrack, CustomVideoTrackInitConfig, CameraVideoTrackInitConfig, BeautyEffectOptions, VideoEncoderConfiguration, VideoEncoderConfigurationPreset, IAgoraRTC, IAgoraRTCClient, VideoPlayerConfig } from "agora-rtc-sdk-ng";
import { VideoSenderType, ScreenVideoWithAudio } from "~/interface";
import { IRtcData } from "~/interface";
declare const AgoraVideoSender_base: import("vue-class-component/lib/declarations").VueClass<unknown>;
export default class AgoraVideoSender extends AgoraVideoSender_base {
    rtcData: IRtcData;
    AgoraRTC: IAgoraRTC;
    hasJoin: boolean;
