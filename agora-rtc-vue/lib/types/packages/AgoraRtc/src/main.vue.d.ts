...
import { IRtcData, TMediaType, AgoraRtcVueClientConfig } from "~/interface";
declare const Agora_base: import("vue-class-component/lib/declarations").VueClass<unknown>;
export default class Agora extends Agora_base {
