...
declare const AgoraAudioSender_base: import("vue-class-component/lib/declarations").VueClass<unknown>;
export default class AgoraAudioSender extends AgoraAudioSender_base {
    rtcData: IRtcData;
    ...
    beforeDestroy(): void;
    __createTrackProcess(this: AgoraAudioSender): Promise<void>;
